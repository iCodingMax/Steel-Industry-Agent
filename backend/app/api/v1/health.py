...
from app.core.database import MySQLAsyncSession, PGAsyncSession
...
async def health_check():
    ...
    try:
        ...
        checks["database"] = {"status": "healthy", "message": "MySQL连接正常"}
    ...
    try:
        async with PGAsyncSession() as db:
            await db.execute(select(1))
        checks["postgres"] = {"status": "healthy", "message": "PostgreSQL连接正常"}
    except Exception as e:
